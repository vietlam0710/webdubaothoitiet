...
const handleClick = (event) =>{
    if(event.keyCode == 13){
        ...
        .then ((data)=>{
            ...
            city.innerHTML = "";
            data.list.map((n) => {
                city.innerHTML +=showCity(n.fla, n.cityName,n.lat,n.lon,n.temp,n.tempMin,n.tempMax,n.wind,n.clo);
            });
...
const handleSeach = (lat, lon, cityName) =>{
    ...
    fetch(api)
        ...
        .then((data) => {
          ...
          content.innerHTML="";
          content.innerHTML += wertherShow(getTime,cityName, hours, minutes,phaseTime,daily, icon);
        });
}
const wertherShow = (getDay,getTime,cityName, hours, minutes,phaseTime,daily,icon) => `
<div>
...
${
    ...
    (n) =>{
        ...
        <div class="w-1 bg-red-300 shadow-8 md:shadow-4 border-round">
            <img class="w-full" src="https://openweathermap.org/img/wn/${icon}@2x.png" alt="">
